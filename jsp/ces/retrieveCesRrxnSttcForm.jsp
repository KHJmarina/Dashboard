...
function fnRetrieve() {
    ...
    new CommonAjax("/dshBr/ces/retrieveCesRrxnSttc.do")
...
function fnRetrieveAllChart(dataSet) {
	...
	let tableDataSet = dataChanger.init()
	   ...
	   .setDataset(dataSet)
	   .setIncludeColumns({
		  "befTotRxnRt" : srchDate.clone().subtract(1, 'year').format('YYYY'),
		  "aftTotRxnRt" : srchDate.format('YYYY')
	   }, 'gubun')
	   .build();
...
function fnRetrieveSeoulChart(dataSet) {
	...
	let tableDataSet = dataChanger.init()
	   ...
	   .setDataset(dataSet)
	   .setIncludeColumns({
		  "befRxnRt" : srchDate.clone().subtract(1, 'year').format('YYYY'),
		  "aftRxnRt" : srchDate.format('YYYY')
	   }, 'gubun')
	   .build();
...
function fnRetrieveDjChart(dataSet) {
	...
	let tableDataSet = dataChanger.init()
	   ...
	   .setDataset(dataSet)
	   .setIncludeColumns({
		  "befDjRxnRt" : srchDate.clone().subtract(1, 'year').format('YYYY'),
		  "aftDjRxnRt" : srchDate.format('YYYY')
	   }, 'gubun')
	   .build();
